...
- (BOOL)dx_application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions  {
    ...
    [[ADManager shareInstance] prloadADSuccess:^{
        [weakSelf configPushWithLaunchOption:launchOptions channel:@"pushChannel0"];
    } failure:^{
        [weakSelf configPushWithLaunchOption:launchOptions channel:@"pushChannel1"];
    }];
